...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fbox{\colorbox{fillyellow}{\parbox[c][6cm][c]{0.83\linewidth}{\centering \textcolor{fillorange}{\textbf{[[TO FILL
F5: failure-cases figure (\texttt{failure\_cases.pdf}),\\ 3 rows $\times$ 3 columns\\ (Input / GT / FANet prediction),
