...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% === NEW-REFERENCES BLOCK: 等文献核实 workflow 结果回来后填入 ===
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textcolor{red}{[PLACEHOLDER-RELATED-WORK-PARAGRAPH]}\\[10pt]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textcolor{red}{
To clarify the representativeness of the frequency-based visualization, the sample in Fig.~\ref{ablavis_rebuttal}
...
\textcolor{red}{The caption of Fig.~6 has been rewritten as follows (shown here together with the figure):}
...
\textcolor{red}{In the revised manuscript, the newly added subsection is shown below:}
...
conditions. Fig.~\ref{failure_rebuttal} presents representative failure cases; these examples are typical instances
...
predicted crack tends to be fragmented into disconnected segments (first row of Fig.~\ref{failure_rebuttal}).
}
...
segment them as false positives (second row of Fig.~\ref{failure_rebuttal}), since the frequency prior alone cannot
...
though the main crack body is still recovered (third row of Fig.~\ref{failure_rebuttal}).
}
