...
\emph{Baseline + FAM (Low-Freq)} in Table~II, respectively; the caption reports a per-image AIU for each panel, computed with the same evaluation code as Table~II over the threshold set \cck{$T=\{0.01, 0.02, \ldots, 0.99\}$}.
}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.62\linewidth]{failure_cases_v3.pdf}
